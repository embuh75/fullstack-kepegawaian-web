...
router.post("/", authenticate, hasPermission("pegawai:create"), createBodyValidator, uploadFoto.single("foto"), control.create);
router.put("/:id", authenticate, hasPermission("pegawai:update"), updateBodyValidator, uploadFoto.single("foto"), control.update );
