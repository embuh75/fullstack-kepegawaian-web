...
import { JABATAN_OPTIONS } from "../utils/masterData";
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-50 dark:bg-[#141A30] text-slate-600 dark:text-slate-400 text-left">
              <tr>
                ...
                <th className="px-4 py-3 font-medium hidden lg:table-cell">Telepon</th>
              ...
              {loading ? (
                Array.from({ length: 5 }).map((_, i) => (
                  <tr key={i}>
                    ...
                    <td className="px-4 py-3.5 hidden lg:table-cell"><div className="skeleton h-4 w-20 rounded" /></td>
                    <td className="px-4 py-3.5"><div className="skeleton h-4 w-16 rounded ml-auto" /></td>
                  </tr>
                ))
              ) : data.length === 0 ? (
                <tr>
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-slate-800 dark:text-slate-100">{p.nama}</span>
                      </div>
                    </td>
                    <td className="px-4 py-3 text-slate-600 dark:text-slate-400 font-tabular">{p.noKTP}</td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-slate-600 dark:text-slate-400 hidden md:table-cell">{p.alamatEmail || "-"}</td>
                    <td className="px-4 py-3 text-slate-600 dark:text-slate-400 hidden lg:table-cell font-tabular text-xs">{toInternational(p.nomorTelephone) || "-"}</td>
...
const ACTION_COLORS = {
  indigo: "text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10",
  amber: "text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-500/10",
